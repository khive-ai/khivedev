...
"""
Real-time WebSocket server for Claude Code hook events.

Provides WebSocket endpoint for streaming hook events in real-time to
dashboard clients and other subscribers.
"""
